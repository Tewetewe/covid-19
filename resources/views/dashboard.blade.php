                                ...
                                <tbody>
                                    @for ($i = 1; $i <= 186; $i++)
                                        <tr>
                                            ...
                                            <td align="right"> {{($global[$i-1 + (sizeof($global)-186)]->Confirmed == 0 || $global[$i-1 + (sizeof($global)-186)]->Confirmed == NULL) ? 0 : number_format(($global[$i-1 + (sizeof($global)-186)]->Recovered/($global[$i-1 + (sizeof($global)-186)]->Confirmed)*100),2)  }}</td>
                                            <td align="right">{{ number_format($global[$i-1 + (sizeof($global)-186)]->Deaths,0,",",",") }}</td>
                                            <td align="right">{{($global[$i-1 + (sizeof($global)-186)]->Confirmed == 0 || $global[$i-1 + (sizeof($global)-186)]->Confirmed == NULL) ? 0 : number_format(($global[$i-1 + (sizeof($global)-186)]->Deaths/($global[$i-1 + (sizeof($global)-186)]->Confirmed)*100),2) }}</td>
                                        </tr>
                                    @endfor
                                </tbody>
                            </table>
                                ...
                                <tbody>
                                    @for ($i = 1; $i <= 34; $i++)
                                        <tr>
                                            ...
                                            <td align="right">{{ number_format(($provinsi[$i-1 + (sizeof($provinsi)-34)]->Kasus_Meni/($provinsi[$i-1 + (sizeof($provinsi)-34)]->Kasus_Posi)*100),2) }}</td>
