...
class HomeController extends Controller
{
    ...
    public function index()
    {
        ...
        $namaNegaraData = GlobalData::select('OBJECTID')
        ...
        $positifProv = ($positifProv);
        $sembuhProv = ($sembuhProv);
        $meninggalProv = ($meninggalProv);
        $dirawatProv = ($dirawatProv);
        $nama = "DKI Jakarta";
        ...
        $positifNegara = ($positifNegara);
        $sembuhNegara = ($sembuhNegara);
        $meninggalNegara = ($meninggalNegara);
        $dirawatNegara = ($dirawatNegara);
        ...
        $dataDirawatNegara = array();

        $positifDateNegara = array();
        $sembuhDateNegara = array();
        $meninggalDateNegara = array();
        $dirawatDateNegara = array();

        $dataPositifNegaraDiff = array();
        $dataSembuhNegaraDiff = array();
        $dataMeninggalNegaraDiff = array();
        $dataDirawatNegaraDiff = array();

        $positifDateNegaraDiff = array();
        $sembuhDateNegaraDiff = array();
        $meninggalDateNegaraDiff = array();
        ...
        for ($i=1; $i < count($dataNegara); $i++) {
            ...
            array_push($sembuhDateNegaraDiff, date('d-F', strtotime($dataNegara[$i]->created_at)));
            array_push($dataSembuhNegaraDiff, $selisih);
        }
        for ($i=1; $i < count($dataNegara); $i++) {
            ...
            array_push($meninggalDateNegaraDiff, date('d-F', strtotime($dataNegara[$i]->created_at)));
            array_push($dataMeninggalNegaraDiff, $selisih);
        }
        for ($i=1; $i < count($dataNegara); $i++) {
            $selisih = (($dataNegara[$i]->Confirmed - $dataNegara[$i]->Recovered - $dataNegara[$i]->Deaths) - ($dataNegara[$i-1]->Confirmed - $dataNegara[$i-1]->Recovered - $dataNegara[$i-1]->Deaths));
            if ($selisih < 0){
                $selisih = 0;
            }
            array_push($dirawatDateNegaraDiff, date('d-F', strtotime($dataNegara[$i]->created_at)));
            array_push($dataDirawatNegaraDiff, $selisih);
        }


        for ($i=0; $i < count($dataNegara); $i++) {
            array_push($positifDateNegara, date('d-F', strtotime($dataNegara[$i]->created_at)));
            array_push($dataPositifNegara, $dataNegara[$i]->Confirmed);
        }
        for ($i=0; $i < count($dataNegara); $i++) {
            array_push($sembuhDateNegara, date('d-F', strtotime($dataNegara[$i]->created_at)));
            array_push($dataSembuhNegara, $dataNegara[$i]->Recovered);
        }
        for ($i=0; $i < count($dataNegara); $i++) {
            array_push($meninggalDateNegara, date('d-F', strtotime($dataNegara[$i]->created_at)));
            array_push($dataMeninggalNegara, $dataNegara[$i]->Deaths);
        }
        for ($i=0; $i < count($dataNegara); $i++) {
            array_push($dirawatDateNegara, date('d-F', strtotime($dataNegara[$i]->created_at)));
        ...
        $positifBali = ($positifBali);
        $sembuhBali = ($sembuhBali);
        $meninggalBali = ($meninggalBali);
        $dirawatBali = ($dirawatBali);
        ...
        'persenMeninggalGlobal', 'persenDirawatGlobal','persenSembuhProv', 'persenMeninggalProv', 'persenDirawatProv','persenSembuhBali', 'persenMeninggalBali', 'persenDirawatBali', 'namaNegaraData', 'namaProvinsi', 'nama',
        ...
        'meninggalDateProvDiff', 'dataMeninggalProvDiff', 'dirawatDateProvDiff', 'dataDirawatProvDiff', 'sembuhDateProv', 'dataSembuhProv', 'meninggalDateProv', 'dataMeninggalProv', 'dirawatDateProv', 'dataDirawatProv','diffMeninggalNegara','diffPositifNegara',
        'diffSembuhNegara', 'positifNegara','sembuhNegara','meninggalNegara','dataPositifNegara','positifDateNegara', 'dataPositifNegaraDiff','positifDateNegaraDiff','dirawatNegara','diffDirawatNegara', 'persenSembuhNegara',
        'persenMeninggalNegara', 'persenDirawatNegara','namaNegaraData', 'namaNegara', 'sembuhDateNegara','dataSembuhNegara', 'meninggalDateNegara','dataMeninggalNegara', 'dirawatDateNegara','dataDirawatNegara', 'sembuhDateNegaraDiff', 'dataSembuhNegaraDiff',
        'meninggalDateNegaraDiff', 'dataMeninggalNegaraDiff', 'dirawatDateNegaraDiff', 'dataDirawatNegaraDiff'));
    }
    public function filter(Request $request){
        ...
        'diffSembuhNegara', 'positifNegara','sembuhNegara','meninggalNegara','dataPositifNegara','positifDateNegara', 'dataPositifNegaraDiff','positifDateNegaraDiff','dirawatNegara','diffDirawatNegara', 'persenSembuhNegara',
        'persenMeninggalNegara', 'persenDirawatNegara','namaNegaraData', 'namaNegara', 'sembuhDateNegara','dataSembuhNegara', 'meninggalDateNegara','dataMeninggalNegara', 'dirawatDateNegara','dataDirawatNegara', 'sembuhDateNegaraDiff', 'dataSembuhNegaraDiff',
        'meninggalDateNegaraDiff', 'dataMeninggalNegaraDiff', 'dirawatDateNegaraDiff', 'dataDirawatNegaraDiff','diffMeninggalNegara','diffPositifNegara',
        'diffSembuhNegara', 'positifNegara','sembuhNegara','meninggalNegara','dataPositifNegara','positifDateNegara', 'dataPositifNegaraDiff','positifDateNegaraDiff','dirawatNegara','diffDirawatNegara', 'persenSembuhNegara',
        'persenMeninggalNegara', 'persenDirawatNegara','namaNegaraData', 'namaNegara', 'sembuhDateNegara','dataSembuhNegara', 'meninggalDateNegara','dataMeninggalNegara', 'dirawatDateNegara','dataDirawatNegara', 'sembuhDateNegaraDiff', 'dataSembuhNegaraDiff',
        'meninggalDateNegaraDiff', 'dataMeninggalNegaraDiff', 'dirawatDateNegaraDiff', 'dataDirawatNegaraDiff'));
    ...
    public function filterGlobal(Request $request){
        ...
        $dataNegara = GlobalData::where('OBJECTID',$namaNegara)->orderBy('created_at', 'asc')->where('Province', NULL)->get();   
        $positifNegara = GlobalData::orderBy('created_at', 'desc')->where('OBJECTID',$namaNegara)->where('Province', NULL)->take(1)->value('Confirmed');
        $sembuhNegara = GlobalData::orderBy('created_at', 'desc')->where('OBJECTID',$namaNegara)->where('Province', NULL)->take(1)->value('Recovered');
        ...
        // $sembuhNegara = number_format($sembuhNegara);
        // $meninggalNegara = number_format($meninggalNegara);

        $DiffNegara = GlobalData::where('OBJECTID',$namaNegara)->where('Province', NULL)->orderBy('created_at', 'desc')->take(2)->get();
        $dataPositifNegara = array();
        $dataSembuhNegara = array();
        $dataMeninggalNegara = array();
        $dataDirawatNegara = array();
        ...
        'diffSembuhProv', 'positifBali', 'sembuhBali', 'meninggalBali', 'positifProv', 'sembuhProv', 'meninggalProv','dirawatGlobal','diffDirawatGlobal','dirawat','diffDirawat','dirawatProv',
        'diffDirawatProv','dirawatBali','diffDirawatBali', 'diffPositifBali', 'diffMeninggalBali', 'diffSembuhBali', 'persenSembuh', 'persenMeninggal', 'persenDirawat', 'persenSembuhGlobal',
        'persenMeninggalGlobal', 'persenDirawatGlobal','persenSembuhProv', 'persenMeninggalProv', 'persenDirawatProv','persenSembuhBali', 'persenMeninggalBali', 'persenDirawatBali','namaNegaraData', 'namaProvinsi', 'namaNegara',
        'sembuhDateGlobal','dataSembuhGlobal', 'meninggalDateGlobal','dataMeninggalGlobal', 'dirawatDateGlobal','dataDirawatGlobal', 'sembuhDateGlobalDiff', 'dataSembuhGlobalDiff',
        'meninggalDateGlobalDiff', 'dataMeninggalGlobalDiff', 'dirawatDateGlobalDiff', 'dataDirawatGlobalDiff', 'dataSembuh', 'sembuhDate', 'dataMeninggal', 'meninggalDate', 'dataDirawat', 'dirawatDate',
        'dataSembuhDiff', 'sembuhDateDiff', 'dataMeninggalDiff', 'meninggalDateDiff', 'dataDirawatDiff', 'dirawatDateDiff', 'dataSembuhBaliDiff', 'sembuhDateBaliDiff', 'dataMeninggalBaliDiff', 'meninggalDateBaliDiff',
        'dataDirawatBaliDiff', 'dirawatDateBaliDiff', 'sembuhDateBali', 'dataSembuhBali', 'meninggalDateBali', 'dataMeninggalBali', 'dirawatDateBali', 'dataDirawatBali', 'sembuhDate' , 'sembuhDateProvDiff', 'dataSembuhProvDiff',
